...
namespace ElCoffe
{
    public class DbConn : DbContext
    {
        ...
        public DbSet<User> elUsers { get; set; }
        public DbSet<Status> elStatuses { get; set; }
        public DbSet<Reservation> elReservations { get; set; }
        public DbSet<Product> elProducts { get; set; }
        public DbSet<Order> elOrders { get; set; }
        public DbSet<Category> elCategories { get; set; }
        public DbSet<Order_Product_Link> elOrder_Product_Links { get; set; }
